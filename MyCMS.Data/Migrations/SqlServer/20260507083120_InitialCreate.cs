        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagDesc = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasterPageName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    RSSFeedEnabled = table.Column<bool>(type: "bit", nullable: false),
                    RSSFeedTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RSSFeedDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RSSFeedItemCount = table.Column<int>(type: "int", nullable: false),
                    HeadScript = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BodyScript = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GoogleAnalyticsId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GoogleAdsenseId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FacebookPixelId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AMPEnabled = table.Column<bool>(type: "bit", nullable: false),
                    AMPAnalyticsId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AMPLogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AMPublisherName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuDesc = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagProperty = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPage = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PageSummary = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    FilePath = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    FileDesc = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ViewCount = table.Column<long>(type: "bigint", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaKeywords = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    FeaturedUpto = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuRemarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ParentMenuItem = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ItemPosition = table.Column<int>(type: "int", nullable: false),
                    Visibility = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
